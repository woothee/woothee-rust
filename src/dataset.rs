...
pub fn get_default_dataset() -> HashMap<String, WootheeResult> {
    ...
    dataset.insert("WinPhone".to_string(),
                   WootheeResult {
                       ...
                       browser_type: "smartphone".to_string(),
    ...
    dataset.insert("docomo".to_string(),
                   WootheeResult {
                       ...
                       browser_type: "mobilephone".to_string(),
                       vendor: "docomo".to_string(),
                       category: "mobilephone".to_string(),
                       os: "docomo".to_string(),
                       ..WootheeResult::default()
                   });
    ...
    dataset.insert("PSP".to_string(),
                   WootheeResult {
                       ...
                       category: "appliance".to_string(),
                       os: "PlayStation Portable".to_string(),
                       ..WootheeResult::default()
                   });
    ...
    dataset.insert("GoogleBot".to_string(),
                   WootheeResult {
                       ...
                       browser_type: "crawler".to_string(),
                       vendor: "".to_string(),
