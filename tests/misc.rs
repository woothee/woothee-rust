    ...
    fn test_misc() {
        ...
        match parser.parse(r#"AppleSyndication/56.1"#) {
            ...
            Some(result) => {
                ...
                assert_eq!(result.name, "Safari RSSReader".to_string());
        ...
        match parser.parse(r#"Mozilla/5.0 (compatible; Google Desktop/5.9.1005.12335; http://desktop.google.com/)"#) {
            ...
            Some(result) => {
                assert_eq!(result.category, "misc".to_string());
                assert_eq!(result.name, "Google Desktop".to_string());
                assert_eq!(result.os, "UNKNOWN".to_string());
                assert_eq!(result.os_version, "UNKNOWN".to_string());
                assert_eq!(result.version, "UNKNOWN".to_string());
            }
        ...
        match parser.parse(r#"Windows-RSS-Platform/2.0 (MSIE 9.0; Windows NT 6.0)"#) {
            ...
            Some(result) => {
                assert_eq!(result.category, "misc".to_string());
                assert_eq!(result.name, "Windows RSSReader".to_string());
                assert_eq!(result.os, "UNKNOWN".to_string());
                assert_eq!(result.os_version, "UNKNOWN".to_string());
                assert_eq!(result.version, "UNKNOWN".to_string());
            }
        ...
        match parser.parse(r#"RssBar/1.29 (RssBar for unDonut 1.35)"#) {
            ...
            Some(result) => {
                assert_eq!(result.category, "misc".to_string());
                assert_eq!(result.name, "RSSReader".to_string());
                assert_eq!(result.os, "UNKNOWN".to_string());
                assert_eq!(result.os_version, "UNKNOWN".to_string());
                assert_eq!(result.version, "UNKNOWN".to_string());
            }
        ...
        match parser.parse(r#"Wget/1.12 (linux-gnu)"#) {
            ...
            Some(result) => {
                ...
                assert_eq!(result.os, "UNKNOWN".to_string());
                assert_eq!(result.os_version, "UNKNOWN".to_string());
                assert_eq!(result.version, "wget".to_string());
            }
        }
        match parser.parse(r#"Apache-HttpClient/UNAVAILABLE (java 1.4)"#) {
            ...
            Some(result) => {
                ...
                assert_eq!(result.os, "UNKNOWN".to_string());
                assert_eq!(result.os_version, "UNKNOWN".to_string());
                assert_eq!(result.version, "Java".to_string());
            }
        }
        ...
        match parser.parse(r#"libwww-perl/5.835"#) {
            ...
            Some(result) => {
                ...
                assert_eq!(result.os, "UNKNOWN".to_string());
                assert_eq!(result.os_version, "UNKNOWN".to_string());
                assert_eq!(result.version, "perl".to_string());
            }
        }
        ...
        match parser.parse(r#"Ruby"#) {
            ...
            Some(result) => {
                ...
                assert_eq!(result.os, "UNKNOWN".to_string());
                assert_eq!(result.os_version, "UNKNOWN".to_string());
                assert_eq!(result.version, "ruby".to_string());
            }
        }
        ...
        match parser.parse(r#"Python-urllib/1.16"#) {
            ...
            Some(result) => {
                ...
                assert_eq!(result.os, "UNKNOWN".to_string());
                assert_eq!(result.os_version, "UNKNOWN".to_string());
                assert_eq!(result.version, "python".to_string());
            }
        }
